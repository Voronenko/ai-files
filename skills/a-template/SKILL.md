...
Agent Skills package domain expertise, new capabilities, and repeatable workflows that agents can use. 
...
This approach keeps agents fast while giving them access to more context on demand. When a task matches a skill's description, the agent reads the full instructions into context and follows 
them—optionally loading referenced files or executing bundled code as needed.
...
## Troubleshooting[​](https://kilo.ai/docs/agent-behavior/skills#troubleshooting "Direct link to Troubleshooting")

### Skill Not Loading?[​](https://kilo.ai/docs/agent-behavior/skills#skill-not-loading "Direct link to Skill Not Loading?")
...
### Common Errors[​](https://kilo.ai/docs/agent-behavior/skills#common-errors "Direct link to Common Errors")
