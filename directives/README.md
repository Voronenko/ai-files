...
**IMPORTANT**: Read `.ai-files/directives/memory-tagging.md` before storing any memories manually.

For detailed directives on specific topics, see `.ai-files/directives/` directory.
```
