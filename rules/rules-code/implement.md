...
a. Read and understand the documentation, plans and tasks in `.ai-files/rules/memory-bank/`
...
- Document these dependencies thoroughly, including the specific usage of functions or logic in files specified in `.ai-files/rules/memory-bank` folder.
</ANALYZE CODE>
...
1. Document Current State in files specified in `.ai-files/rules/memory-bank` folder.
...
3. Document testing as specified in `.ai-files/rules/memory-bank` folder.
</TESTING>
...
b. Update the documentation, plans and tasks in `.ai-files/rules/memory-bank/`.
