...
a. Read the existing documentation and plans in `.ai-files/rules/memory-bank/` (architecture, PRDs, technical docs, active context, plans and tasks).
...
After every Plan/Architect task ALWAYS document and update the plan in `.ai-files/rules/memory-bank/` (architecture, PRDs, technical docs, active context, plans and tasks).
